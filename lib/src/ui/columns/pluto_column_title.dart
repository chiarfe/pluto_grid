...
class CheckboxAllSelectionWidgetState
  ...
  Widget build(BuildContext context) {
    return PlutoScaledCheckbox(
      ...
      tristate: true,
      scale: 0.86,
      unselectedColor: stateManager.configuration.style.checkboxUnselectedColor,
      activeColor: stateManager.configuration.style.checkboxActiveColor,
      checkColor: stateManager.configuration.style.checkboxCheckColor,
    );
  }
}
