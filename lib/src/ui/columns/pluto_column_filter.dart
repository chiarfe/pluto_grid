    ...
    return SizedBox(
      ...
      child: DecoratedBox(
        ...
        child: Padding(
          padding: _padding,
          child: Center(
            child: widget.stateManager.configuration.columnFilter.renderer != null
                ? widget.stateManager.configuration.columnFilter.renderer!(PlutoColumnFilterRendererContext(
                    column: widget.column,
