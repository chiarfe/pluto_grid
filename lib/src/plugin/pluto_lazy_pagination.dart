...
class PlutoLazyPagination extends StatefulWidget {
  ...
  final Widget Function()? pageCountBuilder;
...
class _PlutoLazyPaginationState extends State<PlutoLazyPagination> {
  ...
  Widget build(BuildContext context) {
    return _PaginationWidget(
      ...
      activatedColor: stateManager.style.currPageSelectorColor,
      ...
      setPage: setPage,
      pageCountBuilder: widget.pageCountBuilder,
    );
  }
}
      ...
      builder: (_, size) {
        ...
        return SizedBox(
          ...
          child: Stack(children: [
            if (widget.pageCountBuilder != null)
              Align(
                alignment: Alignment.centerLeft,
                child: widget.pageCountBuilder!(),
              ),
            Align(
