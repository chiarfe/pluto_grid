...
class PlutoGridStyleConfig {
  const PlutoGridStyleConfig({
    ...
    this.checkboxUnselectedColor = Colors.black,
    this.checkboxActiveColor = Colors.white,
    this.checkboxCheckColor = Colors.black,
    this.currPageSelectorColor = Colors.black,
  });
  ...
  const PlutoGridStyleConfig.dark({
    ...
    this.gridBorderRadius = BorderRadius.zero,
    this.gridPopupBorderRadius = BorderRadius.zero,
    this.checkboxUnselectedColor = Colors.white,
    this.checkboxActiveColor = Colors.black,
    this.checkboxCheckColor = Colors.white,
    this.currPageSelectorColor = Colors.white,
  });
  ...
  final Color currPageSelectorColor;
...
typedef PlutoColumnFilterRenderer = Widget Function(PlutoColumnFilterRendererContext context);
